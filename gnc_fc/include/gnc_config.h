...
#define ROCKET_IXX                  0.0050000000f  /* roll inertia [kg*m^2] */
#define ROCKET_IYY                    0.600000f    /* pitch inertia [kg*m^2] */
#define ROCKET_IZZ                    0.600000f    /* yaw inertia [kg*m^2] */
...
#define AERO_2D_ALPHA_BP        { 0.000000f, 2.000000f, 4.000000f, 6.000000f, 8.000000f, 10.000000f }  /* alpha breakpoints [deg] */
#define AERO_2D_MACH_BP         { 0.100000f, 0.200000f, 0.300000f, 0.400000f, 0.500000f }  /* Mach breakpoints */

#define AERO_2D_CNA_TABLE    { \
    17.774431f, 17.999062f, 18.138857f, 18.281453f, 18.452457f, \
    17.230897f, 17.401446f, 17.508867f, 17.619154f, 17.754899f, \
    16.640444f, 16.760959f, 16.844917f, 16.930723f, 17.040277f, \
    17.740412f, 17.892650f, 18.004983f, 18.113631f, 18.219491f, \
    19.608681f, 20.883000f, 21.259930f, 21.408399f, 19.163764f, \
    19.731939f, 19.295819f, 19.340200f, 19.589176f, 20.244001f  \
}
#define AERO_2D_CND_TABLE    { \
    1.407985f, 1.429108f, 1.453283f, 1.482264f, 1.512216f, \
    1.494955f, 1.514428f, 1.534402f, 1.559287f, 1.586939f, \
    1.533221f, 1.559866f, 1.577842f, 1.595358f, 1.608247f, \
    1.186166f, 1.163016f, 0.977951f, 0.873030f, 0.476566f, \
    1.293398f, 0.850164f, -0.080572f, -0.797424f, -0.192059f, \
    -0.217871f, -1.214635f, -1.393626f, -1.250599f, 0.735005f  \
}
...
#define AERO_2D_CMD_TABLE    { \
    22.118110f, 22.539461f, 22.704292f, 22.811290f, 22.918999f, \
    21.984345f, 22.385564f, 22.553245f, 22.678870f, 22.815995f, \
    22.147363f, 22.351436f, 22.354181f, 22.266310f, 22.084470f, \
    21.866843f, 21.901938f, 20.948882f, 18.466528f, 18.299489f, \
    27.407651f, 26.478845f, 23.668500f, 21.582164f, 22.838782f, \
    9.591761f, 10.304495f, 7.409443f, 4.695233f, 7.339246f  \
}
#define AERO_2D_CA0_TABLE    { \
    0.640482f, 0.619070f, 0.610082f, 0.605276f, 0.603319f, \
    0.644883f, 0.622424f, 0.612713f, 0.607460f, 0.605160f, \
    0.648730f, 0.624131f, 0.613324f, 0.607203f, 0.604167f, \
    0.643866f, 0.618048f, 0.606463f, 0.599636f, 0.596001f, \
    0.634299f, 0.608336f, 0.597912f, 0.593934f, 0.595583f, \
    0.643573f, 0.619222f, 0.616944f, 0.619131f, 0.609870f  \
}
#define AERO_2D_CLDA_TABLE    { \
    0.250419f, 0.197054f, 0.171959f, 0.153807f, 0.138130f, \
    0.234529f, 0.179870f, 0.151562f, 0.132005f, 0.115791f, \
    0.142256f, 0.082593f, 0.053308f, 0.034023f, 0.021574f, \
    -0.263663f, -0.328181f, -0.361772f, -0.388939f, -0.348344f, \
    -0.895606f, -0.827160f, -1.016741f, -1.153211f, -1.557593f, \
    -1.559548f, -1.762390f, -1.768226f, -1.667149f, -1.526866f  \
}
...
#define CLDA_ALPHA_BP           { 0.000000f, 2.000000f, 4.000000f, 6.000000f, 8.000000f, 10.000000f }  /* alpha breakpoints [deg] */
#define CLDA_MACH_BP            { 0.100000f, 0.200000f, 0.300000f, 0.400000f, 0.500000f }  /* Mach breakpoints */
...
#define GAIN_TABLE_V_BP         { 40.000000f, 50.000000f, 60.000000f, 70.000000f, 80.000000f, 90.000000f, 100.000000f, 110.000000f, 120.000000f, 130.000000f, 140.000000f, 150.000000f, 160.000000f }  /* velocity breakpoints [m/s] */
#define GAIN_TABLE_KR           { 1.455243f, 0.912218f, 0.618032f, 0.441437f, 0.328122f, 0.250514f, 0.195065f, 0.154196f, 0.131876f, 0.129495f, 0.127100f, 0.124832f, 0.128576f }  /* rate gain */
#define GAIN_TABLE_KA           { 0.631743f, 0.325065f, 0.205580f, 0.144865f, 0.109666f, 0.087473f, 0.072837f, 0.062975f, 0.038189f, 0.033620f, 0.029932f, 0.026890f, 0.023557f }  /* accel gain */
#define GAIN_TABLE_KDC          { 1.000000f, 1.000000f, 1.000000f, 1.000000f, 1.000000f, 1.000000f, 1.000000f, 1.000000f, 1.000000f, 1.000000f, 1.000000f, 1.000000f, 1.000000f }  /* DC gain */
#define GAIN_TABLE_K_PHI        { 11.371638f, 11.853548f, 12.314655f, 12.752765f, 13.166428f, 13.554879f, 13.917950f, 14.255967f, 14.569647f, 14.859996f, 15.128218f, 15.375642f, 15.603656f }  /* roll outer gain */
#define GAIN_TABLE_KP_ROLL      { 1.174758f, 0.815194f, 0.618361f, 0.496055f, 0.402838f, 0.338720f, 0.292897f, 0.256714f, 0.228668f, 0.206934f, 0.189485f, 0.175034f, 0.163340f }  /* roll proportional */
#define GAIN_TABLE_KI_ROLL      { 1.174758f, 0.815194f, 0.618361f, 0.496055f, 0.402838f, 0.338720f, 0.292897f, 0.256714f, 0.228668f, 0.206934f, 0.189485f, 0.175034f, 0.163340f }  /* roll integral */
...
static inline gnc_config_t gnc_config_with_motor(motor_select_t motor_sel)
{
    ...
    cfg.aero_n_mach  = AERO_2D_N_MACH;
    {
        ...
        for (int i = 0; i < AERO_2D_N_ALPHA; i++) cfg.aero_alpha_bp[i] = a_abp[i];
        for (int i = 0; i < AERO_2D_N_MACH;  i++) cfg.aero_mach_bp[i]  = a_mbp[i];
        { float t[] = AERO_2D_CNA_TABLE;
          for (int i = 0; i < AERO_2D_N_ALPHA*AERO_2D_N_MACH; i++) cfg.CNa_2d[i] = t[i]; }
        { float t[] = AERO_2D_CND_TABLE;
          for (int i = 0; i < AERO_2D_N_ALPHA*AERO_2D_N_MACH; i++) cfg.CNd_2d[i] = t[i]; }
        { float t[] = AERO_2D_CMA_TABLE;
          for (int i = 0; i < AERO_2D_N_ALPHA*AERO_2D_N_MACH; i++) cfg.CMa_2d[i] = t[i]; }
        { float t[] = AERO_2D_CMD_TABLE;
          for (int i = 0; i < AERO_2D_N_ALPHA*AERO_2D_N_MACH; i++) cfg.CMd_2d[i] = t[i]; }
        { float t[] = AERO_2D_CA0_TABLE;
          for (int i = 0; i < AERO_2D_N_ALPHA*AERO_2D_N_MACH; i++) cfg.CA0_2d[i] = t[i]; }
        { float t[] = AERO_2D_CLDA_TABLE;
          for (int i = 0; i < AERO_2D_N_ALPHA*AERO_2D_N_MACH; i++) cfg.Clda_2d_new[i] = t[i]; }
    }
